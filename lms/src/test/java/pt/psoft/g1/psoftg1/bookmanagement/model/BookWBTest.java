...
public class BookWBTest {
    ...
    void verifyAddAuthorIsCalledOneTime() throws InstantiationException {
        ...
        // verify
        verify(factoryAuthorDouble, times(1)).newAuthor("aaa1", "João Alberto", "O João Alberto nasceu em Chaves e foi pedreiro a maior parte da sua vida.", null);
    ...
    void verifyAddAuthorIsCalledNTimes() throws InstantiationException {
        ...
        // verify
        verify(factoryAuthorDouble, times(n)).newAuthor("aaa1", "João Alberto", "O João Alberto nasceu em Chaves e foi pedreiro a maior parte da sua vida.", null);
    }
}
