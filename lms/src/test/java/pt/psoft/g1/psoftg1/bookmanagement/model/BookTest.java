...
class BookTest {
    ...
    private final Author validAuthor1 = new Author("aaa1", "João Alberto", "O João Alberto nasceu em Chaves e foi pedreiro a maior parte da sua vida.", null);
    private final Author validAuthor2 = new Author("aaa2","Maria José", "A Maria José nasceu em Viseu e só come laranjas às segundas feiras.", null);
