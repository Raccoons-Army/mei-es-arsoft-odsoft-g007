...
public class FactoryAuthor {
    ...
    public Author newAuthor(String authorNumber, String name, String bio, String photoURI, long version) {
        return new Author(authorNumber, name, bio, photoURI, version);
    }
}
