...
public class BooksCDCDefinitionTest {
    ...
    V4Pact createBookCreatedPact(MessagePactBuilder builder) {
        ...
        body.stringType("isbn", "9789896615246");
        body.stringType("description", "You Shall Not Pass!!!");
        body.stringType("title", "The Lord of the Rings: The Two Towers");
        body.stringType("genre", "Manga");
        ...
        V4Pact pact = builder.expectsToReceive("a book created event")
