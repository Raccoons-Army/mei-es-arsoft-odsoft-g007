...
- [`docs/`](https://github.com/Raccoons-Army/mei-es-arsoft-odsoft-g007/tree/main/docs) has:
  ...
  - [`refactoring2/`](https://github.com/Raccoons-Army/mei-es-arsoft-odsoft-g007/tree/main/docs/refactoring2) where there's all the documentation made by us. Contains the Logic Views, Implementation Views, Physical Views and Process Views from the STB (system-to-be) after the 2nd refactoring of the system to microservices.
  - [`devops/`](https://github.com/Raccoons-Army/mei-es-arsoft-odsoft-g007/tree/main/docs/devops) here you can find the documentation of the DevOps part of the project that we implemented.
...
##### 1.1 Core Domain (Innermost Layer)
...
##### 1.2. Application Services (Next Layer)
...
##### 1.3. Interfaces/Adapters (Outer Layer)
...
##### 1.4. External Infrastructure (Outermost Layer)
...
Even though the project was refactored to a microservices architecture, there's still a lot of room to improvement. We could reach an even higher level of granularity where we would have even more microservices with even smaller responsibilities, but even with the current state of the project, it was possible to explore and understand several things about this type of (*sexy*) architecture.

The system is now more scalable and reliable, but there are still some performance issues that need to be resolved. The use of CI/CD mechanisms has helped to automate the deployment process. The project has demonstrated the importance of architectural design in addressing quality attributes and ensuring the system meets the desired requirements.
